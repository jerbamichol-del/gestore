...
const CalculatorInputScreen = React.forwardRef<HTMLDivElement, CalculatorInputScreenProps>(
  ({ onClose, onSubmit, accounts, onNavigateToDetails, formData, onFormChange, onMenuStateChange, isDesktop }, ref) => {
        ...
        <div className="flex-shrink-0 flex flex-col" style={{ height: '52vh' }}>
          ...
          <div className="flex-1 p-2 flex flex-row gap-2 px-4 pb-4">
            <div className="h-full w-4/5 grid grid-cols-3 grid-rows-4 gap-2 num-pad">
              <KeypadButton onClick={() => handleKeyPress('7')} className="text-slate-900 active:bg-slate-200/60">
                7
              </KeypadButton>
              <KeypadButton onClick={() => handleKeyPress('8')} className="text-slate-900 active:bg-slate-200/60">
                8
              </KeypadButton>
              <KeypadButton onClick={() => handleKeyPress('9')} className="text-slate-900 active:bg-slate-200/60">
                9
              </KeypadButton>
              <KeypadButton onClick={() => handleKeyPress('4')} className="text-slate-900 active:bg-slate-200/60">
                4
              </KeypadButton>
              <KeypadButton onClick={() => handleKeyPress('5')} className="text-slate-900 active:bg-slate-200/60">
                5
              </KeypadButton>
              <KeypadButton onClick={() => handleKeyPress('6')} className="text-slate-900 active:bg-slate-200/60">
                6
              </KeypadButton>
              <KeypadButton onClick={() => handleKeyPress('1')} className="text-slate-900 active:bg-slate-200/60">
                1
              </KeypadButton>
              <KeypadButton onClick={() => handleKeyPress('2')} className="text-slate-900 active:bg-slate-200/60">
                2
              </KeypadButton>
              <KeypadButton onClick={() => handleKeyPress('3')} className="text-slate-900 active:bg-slate-200/60">
                3
              </KeypadButton>
              <KeypadButton onClick={() => handleKeyPress(',')} className="text-slate-900 active:bg-slate-200/60">
                ,
              </KeypadButton>
              <KeypadButton onClick={() => handleKeyPress('0')} className="text-slate-900 active:bg-slate-200/60">
                0
              </KeypadButton>
              <KeypadButton
